...
var options = {
    width: '100%',
    height: 720,
    channel: window.localStorage.getItem('fs')
        ? favoriteStreamers.split(',')[0]
        : 'gotaga',
...
initChat(
    window.localStorage.getItem('fs')
        ? favoriteStreamers.split(',')[0]
        : 'gotaga'
)
...
document.getElementById('update').addEventListener('click', (e) => {
    ...
    if (streamer.indexOf('twitch.tv') > -1) streamer = streamer.split('/')[1]
